...
These tasks are handled by other experts.`,
  ...
  },
  {
    ...
    guidelines: `- Using an informal tone appropriate for casual conversations.
...
- Using emojis sparingly if necessary.`,
  },
  {
    ...
    label: "Email",
    prompt:
      "You are an elite-level editor and proofreader with over 20 years of experience in email communication.",
    guidelines: `- Employing a professional tone suitable for business emails.`,
  },
  {
    key: "oral",
    label: "Oral",
    ...
    guidelines: `- Using language that would sound natural when spoken aloud.
